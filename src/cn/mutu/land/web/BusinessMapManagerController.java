...
@Controller
public class BusinessMapManagerController {

	private BusinessMapManagerService mapService;

	@Autowired
	public BusinessMapManagerController(BusinessMapManagerService mapService) {
		this.mapService = mapService;
	}

	// --------------------内容发布-------------------------
	// 查询
	@RequestMapping(value = "/get_maps")
	@ResponseBody
	public Map<String, Object> getLawsList(
			@RequestParam("searchKeyword") String searchKeyword)
			throws SQLException {
		searchKeyword = Encoder.encode(searchKeyword);
		return this.mapService.getBusinessMapList(searchKeyword);
		//
	}
