 ...
 */
@Entity
@Table(name = "dev_zd_info", catalog = "landuse")
public class DevZdInfo implements java.io.Serializable {
	...
	public DevZdInfo(int mbbsm, double dlmj, double ghjzmj, double ghjdmj,
			...
			double esssze, double qyzsr, double qyssze, int isPass) {
		this.mbbsm = mbbsm;
		this.dlmj = dlmj;
		this.ghjzmj = ghjzmj;
		this.ghjdmj = ghjdmj;
	...
	public DevZdInfo(int mbbsm, String ysdm, String kfqdm, String kfqmc,
			...
			double qyzsr, double qyssze, int isPass, String tbnf) {
		this.mbbsm = mbbsm;
		this.ysdm = ysdm;
		this.kfqdm = kfqdm;
		this.kfqmc = kfqmc;
	...
	@Column(name = "MBBSM", nullable = false)
	public int getMbbsm() {
		return this.mbbsm;
	}
	...
	@Column(name = "DLMJ", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "GHJZMJ", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "GHJDMJ", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "GHRJL", nullable = false, precision = 5)
	...
	@Column(name = "GHJZMD", nullable = false, precision = 6)
	...
	@Column(name = "DLMJ1", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "DLMJ2", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "JDZMJ", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "GXYDMJ", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "GXZSBL", nullable = false, precision = 6)
	...
	@Column(name = "GXSR", nullable = false, precision = 15)
	...
	@Column(name = "GXSS", nullable = false, precision = 15)
	...
	@Column(name = "JZMJ", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "JZJDMJ", nullable = false, precision = 15, scale = 4)
	...
	@Column(name = "GDZCTZZE", nullable = false, precision = 15)
	...
	@Column(name = "ESSSZE", nullable = false, precision = 15)
	...
	@Column(name = "QYZSR", nullable = false, precision = 15)
	...
	@Column(name = "QYSSZE", nullable = false, precision = 15)
