...
require([
    ...
    ready(function () {//65.3447265625,4.21875, 135.7470703125, 53.61328125
        ...
        map = new esri.Map("survey_Landuse_div",{
            logo:false
        });

        //---------Ext JS 事件----------
        //初始化选择图层
        comboBoxLayerSelect = Ext.getCmp('survey_Landuse_LayerCombo');
        //图层选择变化时
        ...
        grid = Ext.getCmp('survey_LanduseGrid');
        if (grid) {
        ...
        //地图panel大小变化时
        mapPanel = Ext.getCmp('survey_Landuse_MapPanel');
        if (mapPanel) {
