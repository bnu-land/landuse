/*
 * File: app/view/update_zdinnfo.js
 *
...
Ext.define('MyApp.view.update_zdinnfo', {
    extend: 'Ext.window.Window',
    alias: 'widget.update_zdinnfo',

    requires: [
        'MyApp.view.add_zdinnfoViewModel1',
        'Ext.form.Panel',
            ...
            items: [
                ...
                },
                {
                    ...
                    handler: function(button, e) {
                        var win = Ext.getCmp('update_zdinfo');
                        win.close();
                    },
                    x: 280,
                    y: 520,
                ...
                },
                {
                    ...
                    handler: function(button, e) {
                        ...
                        var myform = Ext.getCmp('update_zdwidinfo').getForm();
                        if (myform.isValid())
                        {
